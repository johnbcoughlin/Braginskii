...
function make_sim_hybrid(::Val{device}; grid_scale_hyperdiffusion_coef) where {device}
    d = Dict{String, Any}()
    ...
    params = RTShared.params(; T_ref=reference_temp(), gz=gravity(), n0, ωpτ, ωcτ, Ae=1/1836)
